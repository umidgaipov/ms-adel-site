...
function lockScroll() {
    ...
    if (scrollbarWidth > 0) {
        ...
        document.querySelector(".site-header")?.style.setProperty("padding-right", `${scrollbarWidth}px`);
    }
}
...
function unlockScroll() {
    ...
    document.querySelector(".site-header")?.style.removeProperty("padding-right");
}
